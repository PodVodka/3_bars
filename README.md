...
Для работы необходимо скачать данные о барах в формате json и сохранить в ту же папку, где находится используемый скрипт. Скачать его можно [на портале data.mos ](https://www.data.mos.ru).Затем программа просит ввести gps-координаты пользователя (например, 37.4564874621 и 55.45687651354) 
